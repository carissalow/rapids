...
def rapids_features(sensor_data_files, time_segment, provider, filter_data_by_segment, *args, **kwargs):
    ...
    minimum_seconds_to_detect_typing_sessions = provider["MINIMUM_SECONDS_TO_DETECT_TYPING_SESSIONS"]
    ...
    if not keyboard_data.empty:
        ...
        if not keyboard_data.empty:
            ...
            keyboard_data["sessionStart"]           = keyboard_data["keyboardStrokeDuration"].apply(lambda x: 1 if x >= minimum_seconds_to_detect_typing_sessions * 1000 else 0)
